...
#define PPC_R11  11  // Scratch: Bank / Mask
#define PPC_R12  12  // Scratch: Target Address / Offset
...
#define PPC_LWBRX(rD, rA, rB)          ((31 << 26) | ((rD) << 21) | ((rA) << 16) | ((rB) << 11) | (534 << 1)) // Native Little-Endian Load
