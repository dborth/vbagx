...
class GameCubeAudioDriver : public AudioDriver
{
	public:
		...
		void startEmulatorAudio() override { AUDIO_RegisterDMACallback(AudioDMACallback); }
		void stopEmulatorAudio() override { emulatorAudio->stopAudio(); AUDIO_RegisterDMACallback(NULL); }
